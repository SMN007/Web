...
<center>
        ...
        <div class="form-step">
            <form method="post" action="next2.php" id="submitForm">
    <h1>Q.3 भारत कब आजाद हुआ था ? </h1>
   
<center><form action="/next2.php" method="get">
  <body>


<label class="container"> 15 अगस्त 1947 को 
  <input type="checkbox">
  <span class="checkmark"></span>
</label>
<label class="container">24 जनवरी 1960 को 
  <input type="checkbox">
  <span class="checkmark"></span>
</label>
<label class="container">17 फरवरी 1973 को 
  <input type="checkbox">
  <span class="checkmark"></span>
</label>
<label class="container">25 अक्टूबर 1962 को 
  <input type="checkbox">
  <span class="checkmark"></span>
</label>
                ...
                <input class="button" type="submit" value="3/4">
