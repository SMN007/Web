...
<meta name="viewport" content="width=device-width,initial-scale=1.0">
    ...
    <meta property="og:image" content="offer400.png">
...
<div class="ril-step adtop" >            <span class="s-padding"></span>            <p class="s-padding">आपने सभी सवालों के जवाब बिलकुल सही दिए हैं !  </p>            <p class="s-padding">आप अपनी जीती हुई राशि Paytm या Recharge के द्वारा प्राप्त कर सकते हैं !         </p>        <p class="s-padding">       </p>                     </div>
<center>
</center>
      <div class="form-step">
            
<center><form method="get" action="Paytm.php">
    <button type="submit"><img src="paytm.png" alt="HTML tutorial" style="width:130px;height:70px;border:0">
</a><p><b>Paytm</b></p</button>
</form></center>
  <br> 
<center>
<form method="get" action="done.php">
    <button type="submit"><img src="recharge.png" alt="HTML tutorial" style="width:130px;height:70px;border:0">
</a><p><b>Recharge</b></p</button>
</form>
</center>
