...
<center>
        ...
        <div class="form-step">
            <form method="post" action="claim.php" id="submitForm">
    <h1>Q.4 भारत का प्रधानमंत्री कौन है ? </h1>
   
<center><form action="/claim.php" method="get">
  <body>


<label class="container">अटल बिहारी वाजपेयी 
  <input type="checkbox">
...
<label class="container">लालकृष्ण आडवाणी 
  <input type="checkbox">
  <span class="checkmark"></span>
</label>
<label class="container">श्री नरेंद्र मोदी 
  <input type="checkbox">
  <span class="checkmark"></span>
</label>
