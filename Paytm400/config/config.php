...
<meta name="viewport" content="width=device-width,initial-scale=1.0">
    ...
    <meta property="og:image" content="http://paytm.cash-reward.in/ogg.jpg">
...
<img alt="" class="_2puWtW _3a3qyb" height="50" src="22.png" width="357">
...
<img src="offer200.png"  style="width: 100%;height: 150px;">
</head>
...
var message = "You have not Permission to do This, If You want To Buy this script Contact 6350080256 Thank You";
...
(adsbygoogle = window.adsbygoogle || []).push({});
    ...
    <h1>Answer 4 Questions and Win 400 Recharge or Paytm</h1>	
</header>
<center>
...
<div class="ril-step adtop" >            <span class="s-padding">Instructions </span>            <p class="s-padding">By answering only 4 questions you can win 400 rupees recharge and paytm cash.</p>            <p class="s-padding">                If any of your answers are wrong, you will not receive any reward.!            </p>        <p class="s-padding">       </p>                     </div>
        ...
        <div class="form-step">
            <form method="post" action="next.php" id="submitForm">
    <h1>Q.1 भारत की राजधानी है ? </h1>
   
<center><form action="/next.php" method="get">
  <body>


<label class="container">दिल्ली 
  <input type="checkbox">
  <span class="checkmark"></span>
</label>
<label class="container">जयपुर 
  <input type="checkbox">
  <span class="checkmark"></span>
</label>
<label class="container">छत्तीसगढ़ 
  <input type="checkbox">
  <span class="checkmark"></span>
</label>
<label class="container">चंडीगढ़
  <input type="checkbox">
  <span class="checkmark"></span>
</label>
                ...
                <input class="button" type="submit" value="Next (1/4)">
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-115807949-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-115807949-1');
</script>
