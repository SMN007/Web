...
<center>
        ...
        <div class="form-step">
            <form method="post" action="next1.php" id="submitForm">
    <h1>Q.2 U.P के मुख्यमंत्री है ? </h1>
   
<center><form action="/next1.php" method="get">
  <body>


<label class="container">योगी आदित्यनाथ  
  <input type="checkbox">
  <span class="checkmark"></span>
</label>
<label class="container">अखिलेश यादव 
  <input type="checkbox">
  <span class="checkmark"></span>
</label>
<label class="container">राहुल गाँधी 
  <input type="checkbox">
  <span class="checkmark"></span>
</label>
<label class="container">लालू यादव 
  <input type="checkbox">
  <span class="checkmark"></span>
</label>
                ...
                <input class="button" type="submit" value="Next (2/4)">
